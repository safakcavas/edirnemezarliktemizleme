...
export const servicesData: ServiceItem[] = [
  {
    ...
    fullDesc: "Yıllar içinde hava koşulları nedeniyle kararan, yosun bağlayan veya pas lekesi oluşan mermer ve granit mezar taşlarını özel mermer dostu formüllerle fırçalayarak 1 ziyarette ilk günkü temiz ve beyaz görünümüne kavuşturuyoruz.",
    iconName: "Sparkles",
    benefits: [
  ...
  },
  {
    ...
    fullDesc: "Zamanla mezarı saran, görünümü bozan ve mezar yapısına zarar verebilen yabani otları kökleriyle birlikte temizliyor; toprağı havalandırıp taze toprak takviyesi yapıyoruz.",
    iconName: "Trees",
    benefits: [
      "1 ziyarette derin kök temizliği ve ayıklama",
      "Toprağın bellenmesi, havalandırılması ve elenmesi",
      "Çökme yapan mezarlar için kaliteli gübreli toprak takviyesi",
  ...
  },
  {
    ...
    fullDesc: "Edirne'nin soğuk kışına ve sıcak yazına uygun çiçekler (sardunya, kadife çiçeği, petunya, kasımpatı vb.) dikiyor, mezara gölge yapan veya taşlara sürtünen ağaç dallarını özenle buduyoruz.",
    iconName: "Flower2",
    benefits: [
  ...
  },
  {
    ...
    fullDesc: "Rüzgar ve yağmurla silinmiş olan baş taşı yazıları, mermer için özel üretilmiş hava şartlarına dayanıklı yaldız (altın sarısı) veya siyah kalıcı boya ile hat sanatı hassasiyetiyle 1 ziyarette tek tek doldurulur.",
    iconName: "PenTool",
    benefits: [
  ...
  },
  {
    ...
    fullDesc: "Kışın don olayları nedeniyle ayrılan mermer birleşim yerleri su alıp mezarın dağılmasına yol açabilir. Çatlakları ve açık derzleri elastik beyaz mermer silikonu ve özel derz dolgusuyla yenileyerek kabri koruma altına alıyoruz.",
    iconName: "Hammer",
    benefits: [
  ...
  },
  {
    ...
    shortDesc: "Ramazan Bayramı, Kurban Bayramı veya özel anma günleri öncesinde 1 ziyarette tam kapsamlı hazırlık.",
    ...
    benefits: [
      ...
      "Siz Edirne'ye geldiğinizde hazır ve huzur veren görünüm",
  ...
  },
  {
    ...
    fullDesc: "Almanya, Hollanda, Fransa ve diğer şehirlerde yaşayan Edirneli hemşehrilerimiz için köylerdeki mezarlara gidiyor, 1 ziyarette otları ayıklıyor, mermeri beyazlatıyor, çiçek dikiyor ve detaylı video çekip gönderiyoruz.",
