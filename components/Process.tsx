  ...
  const steps = [
    {
      ...
      desc: "Kabrin bulunduğu ilçe, köy veya mezarlık adını, vefat edenin ismini WhatsApp üzerinden bize iletin.",
    },
    {
      step: "02",
      icon: ClipboardCheck,
      title: "Durum Tespiti ve Fiyat",
      desc: "Mezarın mevcut durumunu inceliyor; temizlik, çiçek ve yazı ihtiyaçlarını belirleyip şeffaf teklifimizi sunuyoruz.",
    },
    {
      step: "03",
      icon: Sparkles,
      title: "İtinalı Bakım ve Temizlik",
      desc: "Kendi araç, su ve ekipmanımızla sahaya varıyor; otları ayıklıyor, mermeri parlatıyor ve çiçekleri dikiyoruz.",
    },
    {
      step: "04",
      icon: Camera,
      title: "Fotoğraflı & Videolu Teslimat",
      desc: "İşlem bittiğinde çekilen yüksek kaliteli öncesi/sonrası video ve fotoğrafları WhatsApp’tan size iletiyoruz.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-bold uppercase tracking-wider">
            <ClipboardCheck className="w-3.5 h-3.5 text-emerald-700" aria-hidden="true" />
          ...
          <p className="text-base sm:text-lg text-slate-600">
            Siz nerede olursanız olun; Edirne’deki kabirler emanet hassasiyetiyle
            bakılır, her adımda bilgilendirilirsiniz.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <a
            href={contactConfig.getWhatsappUrl("Merhaba, Edirne'deki mezarımızın bakımı için süreci başlatmak istiyorum.")}
            target="_blank"
            rel="noopener noreferrer"
            aria-label="WhatsApp üzerinden Edirne mezar bakım sürecini başlatın"
