      ...
      <div className="bg-emerald-900 text-emerald-100 text-xs sm:text-sm py-2 px-4 border-b border-emerald-800">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2 text-center sm:text-left">
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-emerald-800 text-emerald-200">
              <MapPin className="w-3 h-3 mr-1 inline" /> Edirne & Köyleri
            </span>
            ...
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-xl sm:text-2xl font-black tracking-tight text-slate-900 leading-tight">
                  Edirne <span className="text-emerald-700">Mezar Bakım</span>
                </span>
