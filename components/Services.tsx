      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
            Edirne ve Köylerinde Sunduğumuz Hizmetler
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicesData.map((service) => {
            ...
            const whatsappMsg = `Merhaba, ${service.title} hizmetiniz hakkında detaylı bilgi ve fiyat teklifi almak istiyorum.`;
          ...
          <div className="grid lg:grid-cols-12 items-center">
            <div className="lg:col-span-7 p-7 sm:p-10 space-y-4 text-center lg:text-left">
              ...
              <p className="text-sm text-slate-300 leading-relaxed max-w-xl">
                Kabir toprağını havalandırıp zenginleştiriyor, sardunya, kadife çiçeği, lavanta ve mevsimlik canlı çiçekleri itina ile dikiyoruz. Mezarınızın fotoğrafını WhatsApp’tan iletin, anında ücretsiz durum tespiti yapalım.
              </p>
            ...
            <div className="lg:col-span-5 h-64 lg:h-full min-h-[260px] relative overflow-hidden">
              <Image
                src="/images/flower-planting-v3.jpg"
