...
import { BookOpen, Calendar, Clock, ArrowRight, MapPin } from "lucide-react";
  ...
  return (
    <section id="blog" className="py-20 bg-slate-50 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="max-w-2xl space-y-3">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-bold uppercase tracking-wider">
              ...
              <span>Edirne Mezar Bakım Rehberleri & Bilgi Köşesi</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              Edirne ve Köyleri İçin Kabir Bakımı & Temizlik Rehberleri
            </h2>
            <p className="text-base text-slate-600 leading-relaxed">
              Mermerin korunması, asitsiz beyazlatma teknikleri, Edirne iklimine dayanıklı mezar
              çiçekleri ve gurbette yaşayan hemşehrilerimiz için hazırladığımız kapsamlı kılavuzlar.
            </p>
          </div>
        ...
        {/* 9 Edirne Districts Quick Links Bar */}
        <div className="mt-12 p-6 rounded-2xl bg-white border border-slate-200/90 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-1 text-xs font-bold text-emerald-800 uppercase tracking-wider">
              ...
              <span>9 Edirne İlçesi ve 253 Köy Kılavuzu</span>
            </div>
            <p className="text-xs text-slate-500">
              Kendi ilçeniz ve bağlı köylerindeki mezarlık şartlarına özel hazırladığımız bakım kılavuzlarını inceleyin:
            </p>
          </div>
