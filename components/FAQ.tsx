      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                <button
                  ...
                  className={`w-full flex items-center justify-between p-5 text-left font-bold text-sm sm:text-base transition-colors ${
                    isOpen
        ...
        <div className="mt-12 text-center p-6 rounded-2xl bg-slate-50 border border-slate-200">
          ...
          <p className="text-xs text-slate-500 mt-1 mb-4">
            Bize dilediğiniz an WhatsApp üzerinden yazabilir veya arayabilirsiniz.
          </p>
          <a
