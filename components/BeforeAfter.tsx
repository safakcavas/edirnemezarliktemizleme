...
const cases: CaseStudy[] = [
  {
    ...
    beforeNotes: [
      ...
      "Hava şartlarından solmuş ve kirlenmiş mezar baş taşı yazıları",
      "Bakımsız kalmış mezar etrafı ve yürüyüş yolu",
    ],
    afterNotes: [
      "Özel mermer temizleme solüsyonu ile ilk günkü pürüzsüz beyazlık",
      "Yabani otlar kökünden temizlendi, havalandırılıp elenmiş taze toprak eklendi",
      "Mevsime uygun canlı kırmızı sardunyalar ve sarı kadifeler dikildi",
      "Baş taşı yazıları netleştirildi, WhatsApp üzerinden HD video ile teslim edildi",
    ],
  },
  {
    id: "case-2",
    ...
    beforeNotes: [
      ...
      "Yağmurlarla mezar ortasında 15 cm çökme yapmış zemin",
      "Mermere yapışmış kuş pisliği ve kireç tortuları",
    ],
    afterNotes: [
      "Gölge yapan dallar budandı, kuru yapraklar tamamen arındırıldı",
      "Mezar taşı yazıları hat ustası hassasiyetiyle siyah boyayla yenilendi",
  ...
  },
  {
    ...
    beforeNotes: [
      ...
      "Susuzluktan sertleşmiş ve çatlamış mezar toprağı",
    ],
    afterNotes: [
      "Toprak baştan başa çapalanıp havalandırıldı",
      "Mevsime uygun 12 kök rengarenk canlı çiçek dikildi",
      "Derinlemesine can suyu verildi ve düzenli sulama takvimine alındı",
      "Arife günü sabahı fotoğraflı ve videolu teslimat yapıldı",
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-bold uppercase tracking-wider">
            ...
            <span>Gerçek Uygulamalarımız</span>
          </div>
